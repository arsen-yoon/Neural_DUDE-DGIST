...
for j in range(1):
    ...
    for k in range(100,k_max+1):
        ...
        ### 2-D N-DUDE Padding ###
        C_two_padding,Y_two_padding = N_DUDE.make_data_for_Two_rnn_n_dude_pd(P_padding[i],P[i],k,
        ...
        #LC[2*int(dim/float(20))-2,] = Hist.history['loss']
        #LC[2*int(dim/float(20))-1,] = Hist.history['acc']
        ...
        res_file='/home/ubuntu/Yoon_ICE/Data_Generation&Save/RNN_Two_PD_k=100~200_outdim_60_epoch_10'
        np.savez(res_file,Error_Two_NN_DUDE_PD = Error_Two_NN_DUDE_PD,
