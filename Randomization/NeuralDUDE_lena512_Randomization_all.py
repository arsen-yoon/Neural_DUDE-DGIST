...
num_NN=3
NN_Time=zeros((len(delta),k_max*(num_NN+1)))
...
for i in range(len(delta)):
    ...
    for k in range(1,k_max+1):
        ...
        proba_bind_new=RD.make_new_proba_NN_DUDE_Bind(proba_bind)
        ...
        X_hat_One_NN_DUDE_Bind[k_max*i+k-1,:]=x_nn_hat_Bind
        ...
        Est_Loss_NN_DUDE[i,k]=est_loss_nn_dude_Bind
        ...
        proba_bind_norm_new=RD.make_new_proba_NN_DUDE_Bind_Norm(proba_bind_norm)
        ...
        X_hat_One_NN_DUDE_Bind_Norm[k_max*i+k-1,:]=x_nn_hat_Bind_Norm
        ...
        Est_Loss_NN_DUDE[i,k]=est_loss_nn_dude_Bind_Norm
        ...
        NN_Time[i,(num_NN+1)*(k-1):(num_NN+1)*k]=One
        
        res_file='/HDD/user/yoon/Yoon_SV4/N-DUDE_SV4/NeuralDUDE_Delta_Variation/Result_Plot/Neural_DUDE_Result_lena512_Randomization_all.npz'
        np.savez(res_file,Error_One_NN_DUDE_RD=Error_One_NN_DUDE_RD, Est_Loss_NN_DUDE_RD=Est_Loss_NN_DUDE_RD, NN_Time=NN_Time)
