...
for i in range(len(delta)):
    ...
    for k in range(1,k_max+1):
        ...
        res_file='/HDD/user/yoon/Yoon_SV4/N-DUDE_SV4/NeuralDUDE_Delta_Variation/Result_Plot/Neural_DUDE_Result_lena512_Randomization_Combine_Norm_lowdelta.npz'
        np.savez(res_file,Error_One_NN_DUDE_Bind_Norm_RD=Error_One_NN_DUDE_Bind_Norm_RD, Est_Loss_NN_DUDE_Bind_Norm_RD=Est_Loss_NN_DUDE_Bind_Norm_RD)
