...
Y_two_padding = N_DUDE.make_data_for_Two_NN_DUDE_PD(P_padding[9],P[9],1,L_new[9*alpha_size:(9+1)*alpha_size,],
...
for epoch in range(100):
    ...
    N_DUDE_CNN.fit([input_1,input_2,input_3,input_4,input_5,input_6,input_7,input_8],Y_test,nb_epoch=1,batch_size=1,verbose=1)
    s_nn_hat_two_PD=N_DUDE_CNN.predict_classes([input_1,input_2,input_3,input_4,input_5,input_6,input_7,input_8], 
    ...
    print '--------------------------'
    print '2-D N-DUDE_CNN_epoch_%d=%0.5f'%(epoch+1,error_nn_two_PD)
    print '--------------------------'