...
data=np.load('/HDD/user/yoon/Yoon_SV4/N-DUDE_SV4/NeuralDUDE_Delta_Variation/Data_Generation&Save/Neural_dude_Data_peppers.npz')
...
for j in range(1):
    ...
    for k in range(19,k_max+1):
        ...
        res_file='/HDD/user/yoon/Yoon_SV4/N-DUDE_SV4/NeuralDUDE_Delta_Variation/Result_Plot/peppers_no_pad_k=1900~2000.npz'
        np.savez(res_file,Error_Two_NN_DUDE=Error_Two_NN_DUDE, Est_Loss_Two_NN_DUDE=Est_Loss_Two_NN_DUDE,
