...
for i in range(len(delta)):
    ...
    for k in range(1,k_max+1):
        ...
        NN_Time[i*3,k-1]=One_NN_Bind_Duration
        NN_Time[i*3+1,k-1]=One_NN_Bind_Norm_Duration
        NN_Time[i*3+2,k-1]=One_NN_Bind_Duration+One_NN_Bind_Norm_Duration
        
        res_file='/HDD/user/yoon/Yoon_SV4/N-DUDE_SV4/NeuralDUDE_Delta_Variation/Result_Plot/Neural_DUDE_Result_lena512_Combined&Norm'
        np.savez(res_file,Error_One_NN_DUDE_Bind=Error_One_NN_DUDE_Bind,
                 ...
                 Hist_Bind=Hist_Bind, Hist_Bind_Norm=Hist_Bind_Norm, NN_Time=NN_Time)
